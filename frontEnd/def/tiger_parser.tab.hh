...
#line 8 "tiger_parser.yy" // lalr1.cc:392
...
#line 60 "tiger_parser.tab.hh" // lalr1.cc:392
...
#line 5 "tiger_parser.yy" // lalr1.cc:392
namespace Tiger {
#line 137 "tiger_parser.tab.hh" // lalr1.cc:392
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ENDD (const location_type& l);
    ...
    static inline
    symbol_type
    make_ASSIGNEQ (const location_type& l);
    ...
    static inline
    symbol_type
    make_LOWEREQ (const location_type& l);
    ...
    static inline
    symbol_type
    make_BECOMES (const location_type& l);
    ...
    Tiger_Parser (Tiger_Scanner &scanner_yyarg, Tiger_Driver  &driver_yyarg);
...
#line 919 "tiger_parser.tab.hh" // lalr1.cc:392
